    ...
    private static Stream<Arguments> logParamProvider() {
        return Stream.of(
                ...
                Arguments.of(List.of("-Djava.util.logging.config.file=" +
                        Path.of(TEST_SRC, "Logging-ALL.properties").toString()), 1,
                        generateStackTraceLogPattern(1)),
                Arguments.of(List.of("-Djava.util.logging.config.file=" +
                        Path.of(TEST_SRC, "Logging-FINER.properties").toString()), 2,
                        generateStackTraceLogPattern(2)),
                Arguments.of(List.of("-Djava.util.logging.config.file=" +
                        Path.of(TEST_SRC, "Logging-FINE.properties").toString()), 3,
                        generateStackTraceLogPattern(3)),
                Arguments.of(List.of("-Djava.util.logging.config.file=" +
                        Path.of(TEST_SRC, "Logging-INFO.properties").toString()), 4,
                        ""),
                Arguments.of(List.of("-Djava.util.logging.config.file=" +
                        Path.of(TEST_SRC, "Logging-WARNING.properties").toString()), 5,
                        ""),
                Arguments.of(List.of("-Djava.util.logging.config.file=" +
                        Path.of(TEST_SRC, "Logging-SEVERE.properties").toString()), 6,
                        ""),
                Arguments.of(List.of("-Djava.util.logging.config.file=" +
                        Path.of(TEST_SRC, "Logging-OFF.properties").toString()), 7,
                        ""),
                ...
                Arguments.of(List.of("-DThrowingHandler",
                        ...
                        Path.of(TEST_SRC, "Logging-FINE.properties").toString()), 15,
